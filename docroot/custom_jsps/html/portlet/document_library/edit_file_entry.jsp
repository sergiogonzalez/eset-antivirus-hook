...
<aui:form action="<%= editFileEntryURL %>" cssClass="lfr-dynamic-form" enctype="multipart/form-data" method="post" name="fm" onSubmit='<%= "event.preventDefault(); " + renderResponse.getNamespace() + "saveFileEntry(false);" %>'>
	...
	//---Custom code for displaying Antivirus Error Message---
	%>

	<liferay-ui:error exception="<%= AntivirusScannerException.class %>" message="the-document-contains-virus-and-it-won't-be-added-to-documents-and-media" />
